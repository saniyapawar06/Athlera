      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        {loading ? <ActivityIndicator color={colors.brand} /> : (
          <>
            ...
            <Pressable testID="profile-match-history-btn" onPress={() => router.push("/match-history")} style={styles.addBtn}>
              <Ionicons name="time-outline" size={20} color={colors.brand} />
              <Text style={styles.addBtnText}>RECENT MATCHES & HISTORY</Text>
            </Pressable>
